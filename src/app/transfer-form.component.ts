...
//[disabled]="isRunning()" si la transferencia esta corriendo deshabilita el form
@Component({
    ...
    <form #form="ngForm" class="w-[400px]" (ngSubmit)="onSubmit(form)">
      ...
      <mat-form-field class="w-full mb-4">
        ...
        @if (form.submitted && memoControl.errors) {
          ...
          <mat-hint>Debe ser el concepto de la transferencia</mat-hint>
        }
      </mat-form-field>
      ...
      <mat-form-field appearance="fill" class="w-full mb-4">
        ...
        <input
          ...
          type="number"
          min="0"
          placeholder="Ingesa el monto acá"
        ...
        @if (form.submitted && amountControl.errors) {
          <mat-error>
            @if (amountControl.errors['required']) {
              ...
              El monto debe ser menor a
              {{ tokenControl.value.balance }}
            }
          </mat-error>
        } @else {
  ...
  onSubmit(form: NgForm) {
    ...
    if (
      ...
      this.sendTransfer.emit({
        ...
        receiverAddress: this.model.receiver,
